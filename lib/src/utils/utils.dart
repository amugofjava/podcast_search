...
class Utils {
  ...
  static const _allowablePatterns = {
    ...
    "([A-Za-z]{3}), ([0-9][0-9]) ([A-Za-z]{3}) ([0-9]{4}) ([0-9][0-9]:[0-9][0-9]:[0-9][0-9]) ([A-Za-z]{3})": 1,

    // Mon, 03 Jun 2019 10:00:00 +02:30 (type 2)
    "([A-Za-z]{3}), ([0-9][0-9]) ([A-Za-z]{3}) ([0-9]{4}) ([0-9][0-9]:[0-9][0-9]:[0-9][0-9]) ([\+|\-][0-9][0-9]:[0-9][0-9])": 2
  };
  ...
  static DateTime parseRFC2822Date(String date) {
    ...
    _allowablePatterns.forEach((k, v) {
      ...
      if (exp.hasMatch(date)) {
        ...
        var month = _months[match.group(3).toLowerCase()];
        var offset = v == 1 ? _timezones[match.group(6)] : match.group(6);
        var iso = '${match.group(4)}-${month}-${match.group(2)}T${match.group(5)}${offset}';
